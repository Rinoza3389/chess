...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_BLUE = SET_TEXT_COLOR + "17m";
    ...
    public static final String SET_BG_COLOR_PALE_BLUE = SET_BG_COLOR + "153m";
    public static final String SET_BG_COLOR_PERSIAN_BLUE = SET_BG_COLOR + "25m";
    public static final String SET_BG_COLOR_BLUEBERRY = SET_BG_COLOR + "69m";
    public static final String SET_BG_COLOR_DARK_MAGENTA = SET_BG_COLOR + "126m";
    public static final String SET_BG_COLOR_PEARLY_PURPLE = SET_BG_COLOR + "133m";
